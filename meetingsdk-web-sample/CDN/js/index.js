...
function websdkready() {
  ...
  var CLIENT_ID = "SRYH_r7OSkGh2V71IhcClQ";
  /**
   ...
   */
  var CLIENT_SECRET = "IvIkFPfS6DRBthbTk0TWRYUb5AKjuKX1";
    ...
    .addEventListener("click", function (e) {
      ...
      var signature = ZoomMtg.generateSDKSignature({
        ...
        success: function (res) {
          ...
          var joinUrl = "/D:/DATATEKNIK/D0020E Datateknik projekt/PepperGUI/meetingsdk-web-sample/CDN/meeting.html?" + testTool.serialize(meetingConfig);
          console.log(joinUrl);
    ...
    var signature = ZoomMtg.generateSDKSignature({
      ...
      success: function (res) {
        ...
        var joinUrl =
          ...
          "/D:/DATATEKNIK/D0020E Datateknik projekt/PepperGUI/meetingsdk-web-sample/CDN/meeting.html?" +
